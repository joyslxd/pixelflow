...
# 用途：兼容历史素材域的错误证书；影响：仅在已白名单且无凭据的素材 URL 上放宽 TLS 主机名校验，不能扩展为任意 vitamazing 子域。
_ASSET_THUMBNAIL_LEGACY_INSECURE_TLS_HOSTS = frozenset({"devtos.vitamazing.top", "www.vitamazing.top"})

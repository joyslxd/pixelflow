...
set "PACKAGE_NAME=pixelflow-backend-dev.tar.gz"
...
if errorlevel 1 (
  ...
  echo Please run this script on Windows 10/11, or install Git for Windows and use package-backend-dev.sh with Git Bash.
  exit /b 1
)

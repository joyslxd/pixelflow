...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    server: {
      port: 5273,
      proxy: {
        "^/agent2(/|$)": { target: API_TARGET, changeOrigin: true, secure: false },
